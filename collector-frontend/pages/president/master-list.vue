          ...
          <table class="w-full text-sm">
            ...
            <tbody class="bg-white">
              <tr v-for="(member, index) in filteredMembers" :key="member.member_id" class="hover:bg-gray-50 border-b border-gray-200">
                ...
                <td class="px-4 py-3 text-gray-900 border-r border-gray-200 text-right">₱{{ (member.aselco || 0).toFixed(2) }}</td>
                <td class="px-4 py-3 text-gray-900 border-r border-gray-200 text-right">₱{{ (member.diesel || 0).toFixed(2) }}</td>
