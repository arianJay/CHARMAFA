          ...
          >
            <table class="w-full text-sm">
              <thead class="bg-green-50">
                <tr>                  <th class="px-4 py-3 text-left text-xs font-medium text-gray-700 uppercase whitespace-nowrap">Status</th>
                  ...
                  <th class="px-4 py-3 text-left text-xs font-medium text-gray-700 uppercase whitespace-nowrap">Date of Birth</th>
                  <th class="px-4 py-3 text-left text-xs font-medium text-gray-700 uppercase whitespace-nowrap">Place of Birth</th>
                  <th class="px-4 py-3 text-left text-xs font-medium text-gray-700 uppercase whitespace-nowrap">Sex</th>
                  <th class="px-4 py-3 text-left text-xs font-medium text-gray-700 uppercase whitespace-nowrap">Civil Status</th>
                  <th class="px-4 py-3 text-left text-xs font-medium text-gray-700 uppercase whitespace-nowrap">Religion</th>
                  <th class="px-4 py-3 text-left text-xs font-medium text-gray-700 uppercase whitespace-nowrap">Ethnicity</th>
                  <th class="px-4 py-3 text-left text-xs font-medium text-gray-700 uppercase whitespace-nowrap">Language</th>
                  <th class="px-4 py-3 text-left text-xs font-medium text-gray-700 uppercase whitespace-nowrap">Mobile No</th>
                  <th class="px-4 py-3 text-left text-xs font-medium text-gray-700 uppercase whitespace-nowrap">Height</th>
                  <th class="px-4 py-3 text-left text-xs font-medium text-gray-700 uppercase whitespace-nowrap">Weight</th>
                  <th class="px-4 py-3 text-left text-xs font-medium text-gray-700 uppercase whitespace-nowrap">Occupation</th>
                  <th class="px-4 py-3 text-left text-xs font-medium text-gray-700 uppercase whitespace-nowrap">Company Address</th>
                  <th class="px-4 py-3 text-left text-xs font-medium text-gray-700 uppercase whitespace-nowrap">Education</th>
                  <th class="px-4 py-3 text-left text-xs font-medium text-gray-700 uppercase whitespace-nowrap">Course</th>
                  <th class="px-4 py-3 text-left text-xs font-medium text-gray-700 uppercase whitespace-nowrap">Year Graduated</th>
                  <th class="px-4 py-3 text-left text-xs font-medium text-gray-700 uppercase whitespace-nowrap">School Address</th>
                  ...
                  <th class="px-4 py-3 text-left text-xs font-medium text-gray-700 uppercase whitespace-nowrap">Barangay</th>
                  <th class="px-4 py-3 text-left text-xs font-medium text-gray-700 uppercase whitespace-nowrap">Municipality</th>
                  <th class="px-4 py-3 text-left text-xs font-medium text-gray-700 uppercase whitespace-nowrap">Province</th>
                  <th class="px-4 py-3 text-left text-xs font-medium text-gray-700 uppercase whitespace-nowrap">Region</th>
                  <th class="px-4 py-3 text-left text-xs font-medium text-gray-700 uppercase whitespace-nowrap">Zip Code</th>
                  <th class="px-4 py-3 text-left text-xs font-medium text-gray-700 uppercase whitespace-nowrap">Spouse Name</th>
                  <th class="px-4 py-3 text-left text-xs font-medium text-gray-700 uppercase whitespace-nowrap">Spouse DOB</th>
                  <th class="px-4 py-3 text-left text-xs font-medium text-gray-700 uppercase whitespace-nowrap">Spouse Address</th>
                  <th class="px-4 py-3 text-left text-xs font-medium text-gray-700 uppercase whitespace-nowrap">Spouse Ethnicity</th>
                  <th class="px-4 py-3 text-left text-xs font-medium text-gray-700 uppercase whitespace-nowrap">Spouse Occupation</th>
                  <th class="px-4 py-3 text-left text-xs font-medium text-gray-700 uppercase whitespace-nowrap">Spouse Phone</th>
                  <th class="px-4 py-3 text-left text-xs font-medium text-gray-700 uppercase whitespace-nowrap">Government ID Type</th>
                  <th class="px-4 py-3 text-left text-xs font-medium text-gray-700 uppercase whitespace-nowrap">Government ID No</th>
                  <th class="px-4 py-3 text-left text-xs font-medium text-gray-700 uppercase whitespace-nowrap">Membership Fee</th>
                  <th class="px-4 py-3 text-left text-xs font-medium text-gray-700 uppercase whitespace-nowrap">Registration Date</th>
              ...
              <tbody class="divide-y divide-gray-200 bg-white">
                ...
                >
                  ...
                  <td class="px-4 py-3 text-gray-900 whitespace-nowrap">{{ member.account_no }}</td>
                  ...
                  <td class="px-4 py-3 text-gray-900 whitespace-nowrap">{{ formatDate(member.date_of_birth) }}</td>
                  <td class="px-4 py-3 text-gray-900 whitespace-nowrap">{{ member.place_of_birth || '-' }}</td>
                  <td class="px-4 py-3 text-gray-900 whitespace-nowrap">{{ member.sex }}</td>
                  <td class="px-4 py-3 text-gray-900 whitespace-nowrap">{{ member.civil_status || '-' }}</td>
                  <td class="px-4 py-3 text-gray-900 whitespace-nowrap">{{ member.religion || '-' }}</td>
                  <td class="px-4 py-3 text-gray-900 whitespace-nowrap">{{ member.ethnicity || '-' }}</td>
                  <td class="px-4 py-3 text-gray-900 whitespace-nowrap">{{ member.language || '-' }}</td>
                  <td class="px-4 py-3 text-gray-900 whitespace-nowrap">{{ member.mobile_no || '-' }}</td>
                  <td class="px-4 py-3 text-gray-900 whitespace-nowrap">{{ member.height ? member.height + ' feet' : '-' }}</td>
                  <td class="px-4 py-3 text-gray-900 whitespace-nowrap">{{ member.weight ? member.weight + ' kg' : '-' }}</td>
                  <td class="px-4 py-3 text-gray-900 whitespace-nowrap">{{ member.occupation || '-' }}</td>
                  <td class="px-4 py-3 text-gray-900 max-w-xs truncate">{{ member.company_address || '-' }}</td>
                  <td class="px-4 py-3 text-gray-900 whitespace-nowrap">{{ member.education_attainment || '-' }}</td>
                  <td class="px-4 py-3 text-gray-900 whitespace-nowrap">{{ member.course || '-' }}</td>
                  <td class="px-4 py-3 text-gray-900 whitespace-nowrap">{{ member.year_graduated || '-' }}</td>
                  <td class="px-4 py-3 text-gray-900 max-w-xs truncate">{{ member.school_address || '-' }}</td>
                  ...
                  <td class="px-4 py-3 text-gray-900 whitespace-nowrap">{{ member.barangay }}</td>
                  <td class="px-4 py-3 text-gray-900 whitespace-nowrap">{{ member.municipality }}</td>
                  <td class="px-4 py-3 text-gray-900 whitespace-nowrap">{{ member.province }}</td>
                  <td class="px-4 py-3 text-gray-900 whitespace-nowrap">{{ member.region || '-' }}</td>
                  <td class="px-4 py-3 text-gray-900 whitespace-nowrap">{{ member.zip_code || '-' }}</td>
                  <td class="px-4 py-3 text-gray-900 whitespace-nowrap">
                    {{ getSpouseName(member) }}
                  </td>
                  <td class="px-4 py-3 text-gray-900 whitespace-nowrap">{{ member.spouse_date_of_birth ? formatDate(member.spouse_date_of_birth) : '-' }}</td>
                  <td class="px-4 py-3 text-gray-900 max-w-xs truncate">{{ member.spouse_address || '-' }}</td>
                  <td class="px-4 py-3 text-gray-900 whitespace-nowrap">{{ member.spouse_ethnicity || '-' }}</td>
                  <td class="px-4 py-3 text-gray-900 whitespace-nowrap">{{ member.spouse_occupation || '-' }}</td>
                  <td class="px-4 py-3 text-gray-900 whitespace-nowrap">{{ member.spouse_phone_no || '-' }}</td>
                  <td class="px-4 py-3 text-gray-900 whitespace-nowrap">{{ member.government_type_id || '-' }}</td>
                  <td class="px-4 py-3 text-gray-900 whitespace-nowrap">{{ member.government_no || '-' }}</td>
                  <td class="px-4 py-3 text-gray-900 whitespace-nowrap">
                    <span :class="{
                      'bg-green-100 text-green-800': member.membership_fee_id === 1,
                      'bg-blue-100 text-blue-800': member.membership_fee_id === 2,
                      'bg-purple-100 text-purple-800': member.membership_fee_id === 3
                    }" class="px-2 py-1 text-xs font-semibold rounded-full">
                      {{ getMembershipFee(member.membership_fee_id) }}
                    </span>
                  </td>
                  <td class="px-4 py-3 text-gray-900 whitespace-nowrap">{{ formatDate(member.registration_date) }}</td>                  <td class="px-4 py-3 whitespace-nowrap sticky right-0 bg-white">
                    <div class="flex gap-1">                      
                      <button
