      ...
      <div v-else-if="!paymentProcessed" class="max-w-2xl mx-auto">        
        ...
        <div v-if="showOrWarning" class="bg-yellow-50 border-l-4 border-yellow-500 p-4 mb-4">
          <div class="flex items-start">
            ...
            <div class="flex-1">
              <p class="font-medium text-yellow-800">Low OR Number Stock</p>
              <p class="text-sm text-yellow-700 mt-1">
                Only {{ orAvailableCount }} OR numbers remaining. Please inform the administrator to add more OR numbers soon.
              </p>
            </div>
          ...
          <div>
            ...
            <div v-if="!billDetails?.is_balance_payment && billDetails" class="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-6">
              ...
              <div class="space-y-2 text-sm">
                ...
                <div v-if="billDetails.generator_consumption > 0" class="flex justify-between">
                  <span>Generator:</span>
        ...
        <div class="bg-white rounded-lg shadow p-6">
          ...
          <div class="bg-gray-50 p-4 rounded-lg mb-6">
            ...
            <div class="text-sm text-gray-600 space-y-1">
              ...
              <div v-if="!bluetoothPrinter?.isConnected" class="text-red-600">⚠ Please connect to Bluetooth printer first</div>
            </div>
          </div>
  ...
  try {    const data = await api(`/members/${route.params.id}`)
    ...
    try {
      ...
      if (orAvailableCount.value === 0) {
        error.value = 'No OR numbers available. Please contact administrator to add more OR numbers.'
