...
{    public function processPayment(Request $request, $id)
    {
        ...
        try {
            ...
            $remainingBalance = max(0, $totalBill - $amountPaid);
            ...
            if (!$nextOr) {
                DB::rollBack();
                \Log::error('No OR numbers available');
                return response()->json([
                    'message' => 'No OR numbers available. Please contact administrator to add more OR numbers.'
                ], 400);
            }
