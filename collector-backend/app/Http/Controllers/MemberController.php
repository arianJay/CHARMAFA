    ...
    public function update(Request $request, $id)
{
    ...
    }        private function calculateBill($member, $consumption, $info)
    {
        ...
        // If there's no consumption record and member has a previous balance,
        ...
        $totalBill = $subtotal + $miscellaneous + $generatorConsumption + $electricityConsumption + $damages + $prevBalance;
